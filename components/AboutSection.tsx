      ...
      <div className="flex-grow flex items-center justify-center px-6 pt-20 pb-10 md:px-12 relative z-10">
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: false }}
            className="relative h-[500px] md:h-[600px] w-full rounded-sm overflow-hidden shadow-2xl max-[415px]:h-[300px]"
          >
            <img
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-8 max-[415px]:text-3xl max-[415px]:mb-4">
              Nuestra Historia
            </h2>
            <p className="text-gray-300 text-lg leading-relaxed mb-6 font-light max-[415px]:text-sm max-[415px]:mb-4">
              <strong className="text-white font-semibold">
                Miami Prime Mortgage LLC
              </strong>{" "}
              nace de la visión de transformar la experiencia hipotecaria en el
              sur de la Florida. Como marca personal y empresarial, nos hemos
              consolidado como el puente de confianza entre el capital y tus
              sueños inmobiliarios.
            </p>
            <p className="text-gray-300 text-lg leading-relaxed font-light mb-10 max-[415px]:text-sm max-[415px]:mb-6">
              A diferencia de las instituciones tradicionales, nuestro enfoque
              es personal. Entendemos que detrás de cada solicitud hay una
              historia de éxito, una familia o una inversión estratégica.
              Nuestro compromiso es brindarte la agilidad y la asesoría experta
              que mereces.
            </p>
            ...
            <div>
              <Button
                onClick={onOpenLoan}
                variant="primary"
                className="bg-blue-600 hover:bg-blue-700 border-blue-600 px-10 py-4 text-base max-[415px]:px-6 max-[415px]:py-3 max-[415px]:text-sm max-[415px]:w-full"
              >
                Precalifícate Ahora
              </Button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-gray-500 text-sm text-center md:text-left">
              &copy; {currentYear} Miami Prime Mortgage LLC. Todos los derechos
              reservados. <br className="md:hidden" /> Prestamista de Vivienda
              Equitativa.
            </p>
